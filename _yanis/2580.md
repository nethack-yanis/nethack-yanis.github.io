...
---
Implement hoard scarabs from D&D. They are a yellow <span class="nhsym clr-yellow">x</span>, which can hide under object piles containing at least 25 gold pieces (and *only* object piles like that; they can't hide under single non-gold objects or furniture or anything; possibly they can only hide under a gold-containing pile when the gold is on the top). They have a nasty poisonous bite.
